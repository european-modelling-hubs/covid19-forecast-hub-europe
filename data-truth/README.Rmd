...
We also provide weekly version of the data files (labelled `...Weekly Incident Hospitalizations.csv`), where any daily data is aggregated into weeks according to the Hub definition (Sunday-Saturday). The latest weekly hospitalisation data is plotted below, with the dashed line indicating data expecting to be substanially revised.
...
issues <- tibble::tibble("issue" = vapply(issues, "[[", "", "title"),
  ...
  mutate(issue = str_to_lower(issue),
         message = str_replace_all(unlistmessage, "\\r\\n", " "),

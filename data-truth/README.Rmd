...
cat(paste0(
  "- **Data warning!** Recent missing data in: ", knitr::combine_words(gaps)
))
```
...
We further provide a set of [recommended_cutoffs.csv](recommended cutoffs) for use with these data.

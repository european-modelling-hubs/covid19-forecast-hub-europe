...
The table below shows forecasts for this week, over the period: `r paste(format(country1wk$death$dates[1], "%d %B"), "to", format(country1wk$death$dates[2], "%d %B %Y"))`

```{r}
knitr::kable(country1wk$death$summary_table,
...
The table below shows forecasts for this week, over the period: `r paste(format(country1wk$case$dates[1], "%d %B"), "to", format(country1wk$case$dates[2], "%d %B %Y"))`

```{r}
knitr::kable(country1wk$case$summary_table,
             format.args = list(big.mark = ","))
```

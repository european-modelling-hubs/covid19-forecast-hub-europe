...
# Evaluation metrics
 ...
 - The first column (n) gives the number of forecasts included in the evaluation. This number may vary across models if they do not make forecasts for all countries, or if they missed some weeks in submitting forecasts.

...
output:
  pdf_document:
    extra_dependencies: ["booktabs", "colortbl", "xcolor"]
title: Ensembles
---
...
table <- read_csv(here::here("ensembles", "evaluation", "weekly-summary",
  ...
  mutate(variable = sub("inc ", "", target_variable),
	 variable = if_else(variable == "hosp", "hospitalisation", variable),
...
```{r wis_plot, fig.width = 10, height = 3, echo = FALSE, fig.cap = "Predictive performance at the 2 week horizon. Main ensembles, using all component models and considering all of the history. Each point is one country."}

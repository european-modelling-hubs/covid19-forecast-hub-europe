...
This metric is calculated for all models that provide a [full set](https://github.com/epiforecasts/covid19-forecast-hub-europe/wiki/Forecast-format#quantile) of quantiles.
 - Relative Absolute Error (`rel_ae`) is the relative absolute error of the predictive point forecasts, that is the predicted value that individual forecasts deem the most likely. This is calculated in a 'pariwise comparison tournament' in the same way as the relative weighted interval score described above.
  ...
  This metric is calculated for all models that provide the relevant quantiles.
 ...
 This metric is calculated for all models that provide quantiles.

...
params: 
  ...
  plot_weeks: 4
  data_weeks: 10
  config: "https://raw.githubusercontent.com/epiforecasts/covid19-forecast-hub-europe/main/forecasthub.yml"
output:
  html_document:
    theme: yeti
...
# `r paste0('European COVID-19 Forecast Hub Evaluation Report', ifelse(params$location_name == 'Overall', '', paste(' for', params$location_name)))`
...
```{r load-data, child = "../rmdchunks/load-data.Rmd", fig.path = here("html", "report-country-files/")}
```

# run evaluation on ensembles
# source: code/papers/forecast-eval/R/re-run-eval.R
# modification: add arg to load_forecasts(): data_processed_subpath = "ensembles/data-processed"
...
raw_forecasts <- load_forecasts(
  data_processed_subpath = "ensembles/data-processed",
  models = NULL,
